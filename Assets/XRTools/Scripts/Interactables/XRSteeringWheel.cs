...
public class XRSteeringWheel : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
{
    ...
    private void RotateWheel()
    {
        ...
        wheelTransform.Rotate(wheelTransform.forward, -angleDifference, Space.World);
