...
namespace InteractionsToolkit.Core
{
    ...
    /// </summary>
    public class GrabKnobInteractable : GrabInteractable, IHandPose
    {
        ...
        public PoseData PrimaryPose { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        public PoseData SecondaryPose { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
